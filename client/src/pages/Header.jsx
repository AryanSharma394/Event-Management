    ...
    <div>
      <header className='flex py-2 px-6 sm:px-6 justify-between place-items-center'>
          ...
          <Link to={'/'} className="flex item-center ">
            <img src="../src/assets/Elev8.png" alt="" className='w-20 h-16'/>
          </Link>
          ...
          <Link to={'/createEvent'}> {/*TODO:Route create event page after creating it */}
            <div className='hidden md:flex flex-col place-items-center py-1 px-2 rounded text-primary cursor-pointer hover:primarydark hover:bg-white hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
              <button>
              ...
              <div className='font-bold text-primary text-sm'>Create Event</div>
            </div>  
          </Link>
        ...
        {!user &&(
          <div>
            ...
            <Link to={'/login'} className=" ">
              <button className="bg-primary text-white py-3 text-lg rounded-lg px-5 ">
                <div>Sign in </div>
              </button>
            </Link>
          </div>
